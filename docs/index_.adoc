...
image::https://gihyo.jp/assets/images/article/2026/02/htmx-introduction/hello.gif[]
...
- link:https://playwright.dev/docs/running-tests[Playwright, Getting Started, Running and debugging tests]
...
- link:https://www.browserstack.com/guide/bun-playwright[browserstack, How to Use Bun for Playwright Tests]
...
- link:https://stephenhaney.com/2024/playwright-on-fly-io-with-bun/[Running playwright on fly.io with bun, Stephen Haney]
...
- link:https://bun.com/docs/installation[bun] 1.3.6
- link:https://hono.dev/docs/getting-started/basic[Hono] ^4.12.5
...
[source,typescript]
----
include::../my-app/src/index.e2e.ts[]
----
...
[source]
----
include::../my-app/package.json[lines=5..6]
----
...
Playwrightのドキュメント link:https://playwright.dev/docs/writing-tests[Getting started/Writing tests] から典型的なPlaywrightテストのサンプルを引用しよう。
...
- link:https://bun.com/reference/bun/test/Expect[bun:test Expect]
- link:https://playwright.dev/docs/test-assertions[playwright: Assertions]
